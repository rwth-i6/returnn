    ...
    if self.network_task == 'train' or self.network_task == 'theano_graph':
      ...
      for extract in extractions:
        ...
        if extract == "classification":
          ...
          source.append(self.testnet.x.reshape((self.testnet.i.shape[0], self.testnet.i.shape[1], self.testnet.x.shape[1])) * T.cast(self.testnet.i.dimshuffle(0,1,'x').repeat(self.testnet.x.shape[1],axis=2),'float32'))
