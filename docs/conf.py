...
project = "RETURNN"
copyright = "2014–2023, %s contributors" % project
...
# This is currently not working for autogenerated reST sources
# Individual links will be available with Sphinx 4.0.0
