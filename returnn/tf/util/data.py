        ...
        *,
        ...
        if sparse_dim is NotSpecified:
            if sparse:
                ...
                sparse_dim = Dim(
                    kind=Dim.Types.Feature, dimension=dim, description="%s:sparse-dim" % name, auto_generated=True
                )
            else:
                sparse_dim = None
...
def _infer_dim_tags_tuple_from_shape(
    shape, batch_dim_axis, time_dim_axis, feature_dim_axis, sparse, batch, size_placeholder, dim_tags, name, extern_data
):
    """
