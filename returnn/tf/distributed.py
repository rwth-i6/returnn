...
class _Controller:
    ...
    def __init__(self, config):
        ...
        server = tf.distribute.Server(
            cluster_spec, job_name=cluster_resolver.task_type, task_index=cluster_resolver.task_id, config=server_config
        )
        self.server = server
...
class ReturnnDefaultStrategy(tf.distribute.Strategy):
    ...
    def __init__(self):
        super(ReturnnDefaultStrategy, self).__init__(extended=ReturnnDefaultStrategyExtended(self))
